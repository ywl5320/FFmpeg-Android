...
static jmethodID midPrepard;
static jmethodID midError;
static jmethodID midComplete;
static jmethodID midLoad;
static jmethodID midPlay;
...
JNIEXPORT void JNICALL SDL_Android_Init(JNIEnv* mEnv, jclass cls)
{
    ...
    midPollInputDevices = (*mEnv)->GetStaticMethodID(mEnv, mActivityClass,
                                "pollInputDevices", "()V");
    midPrepard = (*mEnv)->GetStaticMethodID(mEnv, mActivityClass,
            "onPrepard", "()V");
    midError = (*mEnv)->GetStaticMethodID(mEnv, mActivityClass,
            "onError", "(ILjava/lang/String;)V");
    midComplete = (*mEnv)->GetStaticMethodID(mEnv, mActivityClass,
            "onCompleted", "()V");
    midPlay = (*mEnv)->GetStaticMethodID(mEnv, mActivityClass,
                    "onPlay", "()V");
	midLoad = (*mEnv)->GetStaticMethodID(mEnv, mActivityClass,
					"onLoad", "()V");
...
/* Drop file */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeDropFile(
...
/* Resize */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeResize(
                                    JNIEnv* env, jclass jcls,
...
/* Paddown */
JNIEXPORT jint JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativePadDown(
                                    JNIEnv* env, jclass jcls,
...
/* Padup */
JNIEXPORT jint JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativePadUp(
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeJoy(
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeHat(
                                    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativeAddJoystick(
    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativeRemoveJoystick(
...
/* Surface Created */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeSurfaceChanged(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeSurfaceDestroyed(JNIEnv* env, jclass jcls)
{
...
/* Keydown */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeKeyDown(
...
/* Keyup */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeKeyboardFocusLost(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
/* Mouse */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeMouse(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativeLowMemory(
...
/* Quit */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativePause(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
JNIEXPORT void JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativeResume(
                                    JNIEnv* env, jclass cls)
{
...
JNIEXPORT jstring JNICALL Java_com_ywl5320_wlsdk_player_WlPlayer_nativeGetHint(JNIEnv* env, jclass cls, jstring name) {
...
{
	JNIEnv *env = Android_JNI_GetEnv();
	(*env)->CallStaticVoidMethod(env, mActivityClass, midPrepard);
}
...
void onError(int code, char *msg)
{
	...
	(*env)->CallStaticVoidMethod(env, mActivityClass, midError, code, jmsg);
...
{
	JNIEnv *env = Android_JNI_GetEnv();
	(*env)->CallStaticVoidMethod(env, mActivityClass, midComplete);
}

void onPlay()
{
	JNIEnv *env = Android_JNI_GetEnv();
	(*env)->CallStaticVoidMethod(env, mActivityClass, midPlay);
}

void onLoad()
{
	JNIEnv *env = Android_JNI_GetEnv();
	(*env)->CallStaticVoidMethod(env, mActivityClass, midLoad);
}
